...
This example demonstrates the full capabilities of `@fondation-io/store`, showing how to:
...
This example shows the full power of `@fondation-io/store` - a drop-in replacement for `@ai-sdk/react` that gives you global state management with zero breaking changes!